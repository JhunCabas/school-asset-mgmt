			...
			<div class="inner">
				...
				<?php
					if(isset($_POST['kemaskini'])){
						...
						if($notvalid == true){
							...
							$sql= "UPDATE pelupusan set rujukan='$rujukan', tarikh='$tarikhFormat',kaedah='$kaedah', pengguna_id='$userID'
				...
				<div class="section">
					...
					<div class="section_content">
						...
						$qHmodalSub= "select * from  pelupusan	where id = '$subid' ";
						...
						<form action="" method="POST" class="search_form general_form">
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper" style="width:300px;"><input name="rujukan"  class="text " value="<?php  echo $rHmodalSub['rujukan']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="kaedah"  class="text" value="<?php  echo $rHmodalSub['kaedah']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
