		...
		<div id="content">
			<div class="inner">
				...
				if(!empty($_GET['del_id'])){
					if( empty($_GET['token']) || $_GET['token'] != $_SESSION['tokenInventoriPenempatanDel'] ){
						echo"
						<div class='section'>
							<ul class='system_messages'>
								<li class='red'><span class='ico'></span><strong class='system_title'>Data penempatan tidak boleh dihapuskan!</strong> </li>
							</ul>
						</div>";
					}
					else {
						// All fine: delete 
						$qDel= "delete from penempatan where id = $_GET[del_id]" ;
						$rDel = $db->sql_query($qDel);
						if($rDel){
							echo"
							<div class='section'>
								<ul class='system_messages'>
									<li class='green'><span class='ico'></span><strong class='system_title'>Data penempatan berjaya dihapuskan!</strong> </li>
								</ul>
							</div>";
						}							
						// Unset the token, so that it cannot be used again.
						unset($_SESSION['tokenInventoriPenempatanDel']);
					}
				}

				$token = md5(uniqid(rand(), true));
				$_SESSION['tokenInventoriPenempatanDel'] = $token;
				...
				<?php
					...
					if(isset($_POST['daftar'])){
						...
						if($notvalid == true){
							...
							$sql= "INSERT INTO penempatan (kuantiti, lokasi, tarikh,inventori_id, pengguna_id, tarikh_daftar) VALUES 
								('$kuantiti','$lokasi','$tarikhFormat','$id', '$userID',now())";
							...
							if ($result){	
								...
								<div class="section">
									<ul class="system_messages">
										<li class="green"><span class="ico"></span><strong class="system_title">Penempatan untuk no siri pendaftaran '.$nosiridaftar.' berjaya didaftarkan !</strong>
										<br/> Sila klik tab pemeriksaan jika ingin meneruskan pendaftaran pemeriksaan.</li>
									</ul>
								</div>
									';
							}
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								...
								<ul class="section_menu left">
									...
									<li><a href="pInventoriPenempatan.php?id=<?php echo $id; ?>" class="selected_lk"><span class="l"><span></span></span><span class="m"><em>PENEMPATAN</em><span></span></span><span class="r"><span></span></span></a></li>
					...
					<div class="section_content">
						...
						<form action="" method="POST" class="search_form general_form">
							...
							<fieldset>
								<!--[if !IE]>start forms<![endif]-->
								<div class="forms">
								<h3>Butir-butir Penempatan</h3>
								
								<!--[if !IE]>start row<![endif]-->
								<div class="row">
									<label>KUANTITI:</label>
									<div class="inputs">
										<span class="input_wrapper" ><input name="kuantiti"  maxlength="5" class="text numbersOnly" value="<?php if(isset($_POST['kuantiti'])) echo $_POST['lokasi'] ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									<label>LOKASI:</label>
									<div class="inputs">
										<span class="input_wrapper" style="width:300px;"><input name="lokasi"  class="text " value="<?php if(isset($_POST['lokasi'])) echo $_POST['lokasi'] ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									<div class="inputs">
										<input name="id"  class="text" value="<?php  echo $rInv['id']; ?>" type="hidden"  />
												...
												<tr class="'.$colorRow.'">
													...
													<td>
														<div class="actions_menu" >
															<ul>
																<li><a class="edit" href="pInventoriPenempatanKemaskini.php?id='.$id.'&subid='.$i['0'].'">Kemaskini</a></li>
																<li><a class="delete" href="pInventoriPenempatan.php?id='.$id.'&del_id='.$i['0'].'&token='.$_SESSION['tokenInventoriPenempatanDel'].'">Hapus</a></li>
															</ul>
														</div>
													</td>
												</tr>';
