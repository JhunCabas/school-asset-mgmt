					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							<?php
								...
								$param = "&nosiri=$nosiri";
							?>
							<form action="pInventori.php" method="POST" class="search_form">
							...
							<a href="pInventoriDaftar.php" class="update"><span><span><em>Daftar Inventori</em><strong></strong></span></span></a>
							</div>
											...
											<tr class="'.$colorRow.'">
												...
												<td>
													<div class="actions_menu" >
														<ul>
															<li><a class="details" href="pInventoriPapar.php?id='.$i['id'].'">Papar</a></li>
															<li><a class="edit" href="pInventoriKemaskini.php?id='.$i['id'].'">Kemaskini</a></li>
															<li><a class="delete" href="pInventori.php?del_id='.$i['id'].'&token='.$_SESSION['tokenInventoriDel'].'">Hapus</a></li>
														</ul>
													</div>
												</td>
											</tr>';
