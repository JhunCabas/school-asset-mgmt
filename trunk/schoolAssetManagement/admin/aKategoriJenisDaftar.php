				...
				<?php
					...
					if(isset($_POST['daftar'])){
						...
						if($notvalid == true){
							...
							$Qsubcat = "SELECT count(*) from kategori where nama = '$jenis' and parent_id='$subkategori' and level='2'";
							$Tsubcat = $db->sql_total($Qsubcat);	
							
							$Qkod = "SELECT count(*) from kategori where kod = '$kod' and parent_id='$subkategori' and level='2' ";
							...
							if($Tsubcat <> 0){
								echo"
									<div class='section'>
										<ul class='system_messages'>
											<li class='yellow'><span class='ico'></span><strong class='system_title'>Jenis ini sudah digunakan !</strong> </li>
										</ul>
									</div>";
							}
							if($Tkod <> 0){
							...
							if($Tsubcat==0 && $Tkod==0 ){
								...
								//	Display success																			
									...
									<div class="section">
										<ul class="system_messages">
											<li class="green"><span class="ico"></span><strong class="system_title" >Jenis berjaya disimpan !</strong></li>
										</ul>
									</div>
										';
								}
						...
						<form action="" method="POST"  class="search_form general_form">
							...
							<fieldset>
								...
								<div class="row">
									<label>JENIS:</label>
									<div class="inputs">
										<span class="input_wrapper"  style="width: 430px;" ><input class="text alphaonly" name="jenis" type="text" value="<?php if(isset($_POST['jenis'])) echo $_POST['jenis'] ?>" /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
