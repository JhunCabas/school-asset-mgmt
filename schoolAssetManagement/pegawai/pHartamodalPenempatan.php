		...
		<div id="content">
			<div class="inner">
				...
				if(!empty($_GET['del_id'])){
					if( empty($_GET['token']) || $_GET['token'] != $_SESSION['tokenHartamodalPenempatanDel'] ){
						echo"
						<div class='section'>
						...
						unset($_SESSION['tokenHartamodalPenempatanDel']);
					}
				}

				$token = md5(uniqid(rand(), true));
				$_SESSION['tokenHartamodalPenempatanDel'] = $token;
				...
				<?php
					...
					if(isset($_POST['daftar'])){
						...
						if($notvalid == true){
							...
							$createUser= "INSERT INTO penempatan (lokasi, tarikh,harta_modal_id ,pengguna_id, tarikh_daftar) VALUES 
								('$lokasi','$tarikhFormat','$id', '$userID',now())";
					...
					<div class="section_content">
						...
						<form action="" method="POST" class="search_form general_form">
							...
							<fieldset>
								...
								<div class="row">
									<div class="inputs">
										<input name="id"  class="text" value="<?php  echo $rHmodal['id']; ?>" type="hidden"  />
												...
												<tr class="'.$colorRow.'">
													...
													<td>
														<div class="actions_menu" >
															<ul>
																<li><a class="edit" href="pHartamodalPenempatanKemaskini.php?id='.$id.'&subid='.$i['0'].'">Kemaskini</a></li>
																<li><a class="delete" href="pHartamodalPenempatan.php?id='.$id.'&del_id='.$i['0'].'&token='.$_SESSION['tokenHartamodalPenempatanDel'].'">Hapus</a></li>
															</ul>
														</div>
													</td>
												</tr>';
