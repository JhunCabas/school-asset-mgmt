				...
				<?php
					...
					if(isset($_POST['daftar'])){
						...
						if(empty($_POST['jenis'])){
							$errors[] = 'Sila pilih jenis/jenama/model';
							$notvalid = true;
						}
						...
						if($notvalid == true){
							...
							$buatan = strtoupper(mysql_real_escape_string($_POST['buatan'])); 
							$jenisnoenjin = strtoupper(mysql_real_escape_string($_POST['jenisnoenjin'])); 
							$siripembuat = strtoupper(mysql_real_escape_string($_POST['siripembuat'])); 
							$nodaftarkenderaan = strtoupper(mysql_real_escape_string($_POST['nodaftarkenderaan'])); 
							$komponen = strtoupper(mysql_real_escape_string($_POST['komponen'])); 
							...
							$createUser= "INSERT INTO hartamodal (kaedah_peroleh, no_siri_daftar, kementerian, bahagian,
								kod_nasional,kategori_id,sub_kategori_id, jenis_id,buatan,jenis_no_enjin,no_casis,
								no_pendaftaran,komponen,harga_perolehan_asal,tarikh_terima,no_pesanan,tempoh_jaminan,
								pembekal_id,pengguna_id,tarikh_daftar) VALUES 
								('$kaedahperolehan','$nosiripendaftaran', '$kementerian','$bahagian', 
								'$kodnasional','$kategoriID','$kategoriSubID','$jenisID','$buatan','$jenisnoenjin','$siripembuat',
								'$nodaftarkenderaan','$komponen','$hargaasal','$tarikhterimaFormat','$nopesananrasmi','$tempohjaminan',
								'$pembekal','$userID',now())";
							$result = $db->sql_query($createUser);
							$idHartaModal = mysql_insert_id(); 
							...
							if ($result){	
								...
								<div class="section">
									<ul class="system_messages">
										<li class="green"><span class="ico"></span><strong class="system_title">Harta modal berjaya disimpan !</strong>
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								...
								<ul class="section_menu left">
									<li><a href="#" class="selected_lk"><span class="l"><span></span></span><span class="m"><em>HARTA MODAL (KEW.PA-2)</em><span></span></span><span class="r"><span></span></span></a></li>
									<?php if(!empty($idHartaModal)){ ?>
									<li><a href="pHartamodalPenempatan.php?id=<?php echo $idHartaModal; ?>"><span class="l"><span></span></span><span class="m"><em>PENEMPATAN</em><span></span></span><span class="r"><span></span></span></a></li>
									<li><a href="pHartamodalPemeriksaan.php?id=<?php echo $idHartaModal; ?>"><span class="l"><span></span></span><span class="m"><em>PEMERIKSAAN</em><span></span></span><span class="r"><span></span></span></a></li>
									<li><a href="pHartamodalPelupusan.php?id=<?php echo $idHartaModal; ?>"><span class="l"><span></span></span><span class="m"><em>PELUPUSAN/HAPUS KIRA</em><span></span></span><span class="r"><span></span></span></a></li>
									<?php } ?>
							</ul>
							</div>
						</div>
						...
						<form action="" method="POST" class="search_form general_form">
							...
							<fieldset>
								...
								<div class="row">
									<label>BUATAN:</label>
									<div class="inputs">
										<span class="input_wrapper"><input name="buatan" maxlength="30"  class="text " value="<?php if(isset($_POST['buatan'])) echo $_POST['buatan'] ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="jenisnoenjin" maxlength="30" class="text " value="<?php if(isset($_POST['jenisnoenjin'])) echo $_POST['jenisnoenjin'] ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="siripembuat" maxlength="30"  class="text " value="<?php if(isset($_POST['siripembuat'])) echo $_POST['siripembuat'] ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="nodaftarkenderaan" maxlength="30" class="text " value="<?php if(isset($_POST['nodaftarkenderaan'])) echo $_POST['nodaftarkenderaan'] ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper textarea_wrapper" style=" height: 60px; width:300px;">
											<textarea rows="" cols="" class="text" name="komponen" style="overflow:hidden;" ><?php if(isset($_POST['komponen'])) echo $_POST['komponen'] ?></textarea>
										</span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
