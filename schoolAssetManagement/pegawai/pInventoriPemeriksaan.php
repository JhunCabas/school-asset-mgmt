		...
		<div id="content">
			<div class="inner">
				...
				if(!empty($_GET['del_id'])){
					if( empty($_GET['token']) || $_GET['token'] != $_SESSION['tokenInventoriPemeriksaanDel'] ){
						echo"
						<div class='section'>
						...
						unset($_SESSION['tokenInventoriPemeriksaanDel']);
					}
				}

				$token = md5(uniqid(rand(), true));
				$_SESSION['tokenInventoriPemeriksaanDel'] = $token;
				...
				<?php
					...
					if(isset($_POST['daftar'])){
						...
						if($notvalid == true){
							...
							$sql= "INSERT INTO pemeriksaan (status_aset, tarikh,inventori_id, pengguna_id, tarikh_daftar) VALUES 
								('$statusaset','$tarikhFormat','$IdInventori','$userID',now())";
												...
												<tr class="'.$colorRow.'">
													...
													<td>
														<div class="actions_menu" >
															<ul>
																<li><a class="edit" href="pInventoriPemeriksaanKemaskini.php?id='.$id.'&subid='.$i['0'].'">Kemaskini</a></li>
																<li><a class="delete" href="pInventoriPemeriksaan.php?id='.$id.'&del_id='.$i['0'].'&token='.$_SESSION['tokenInventoriPemeriksaanDel'].'">Hapus</a></li>
															</ul>
														</div>
													</td>
												</tr>';
