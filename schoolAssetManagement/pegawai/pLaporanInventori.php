					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2>Senarai Daftar Inventori (KEW.PA-5):</h2>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							<div class="table_tabs_menu">
								<a href="../report.php?type=I&year=<?php echo date('Y');?>" class="print"><span><span><em>CETAK</em><strong></strong></span></span></a>
							</div>
							...
							<div class="table_wrapper">
								...
								<?php  
									...
									*/
									$qCount= "select COUNT(*) from inventori 
