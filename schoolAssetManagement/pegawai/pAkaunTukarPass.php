						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								...
								<ul class="section_menu left">
									<li><a href="pAkaun.php?id=<?php echo $_SESSION['userlogin_id']; ?>"  ><span class="l"><span></span></span><span class="m"><em>Kemaskini Akaun</em><span></span></span><span class="r"><span></span></span></a></li>
									<li><a href="pAkaunTukarPass.php?id=<?php echo $_SESSION['userlogin_id']; ?>"  class="selected_lk" ><span class="l"><span></span></span><span class="m"><em>Reset Kata Laluan</em><span></span></span><span class="r"><span></span></span></a></li>
								</ul>
							</div>
						</div>
