					...
					if(isset($_POST['kemaskini'])){
						...
						if($notvalid == true){
							...
							if ($result){	
								...
								<div class="section">
									<ul class="system_messages">
										<li class="green"><span class="ico"></span><strong class="system_title">Harta modal berjaya dikemaskinikan !</strong></li>
									</ul>
								</div>
									';
							}
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								...
								<ul class="section_menu left">
									<li><a href="pHartamodalKemaskini.php?id=<?php echo $id; ?>" class="selected_lk"><span class="l"><span></span></span><span class="m"><em>HARTA MODAL (KEW.PA-2)</em><span></span></span><span class="r"><span></span></span></a></li>
						...
						<form action="" method="POST" class="search_form general_form">
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper" style="border:none; width:300px;"><input name="kementerian"  maxlength="50" readonly class="text" value="<?php echo $rHmodal['kementerian']; ?>" type="text" /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper" style="border:none; width:300px;"><input name="bahagian"  maxlength="50" readonly class="text" value="<?php echo $rHmodal['bahagian']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="kodnasional" maxlength="16" class="text " value="<?php echo $rHmodal['kod_nasional']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									<label>BUATAN:</label>
									<div class="inputs">
										<span class="input_wrapper"><input name="buatan"  maxlength="30" class="text " value="<?php echo $rHmodal['buatan']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="jenisnoenjin" maxlength="30" class="text " value="<?php echo $rHmodal['jenis_no_enjin']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="siripembuat"  maxlength="30" class="text " value="<?php echo $rHmodal['no_casis']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="nodaftarkenderaan"  maxlength="30" class="text " value="<?php echo $rHmodal['no_pendaftaran']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="hargaasal"  maxlength="6" class="text numbersOnly" value="<?php echo $rHmodal['harga_perolehan_asal']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="tarikhterima" id="datepicker" class="text" value="<?php echo changeDateBeginDay($rHmodal['tarikh_terima']); ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="nopesananrasmi" maxlength="30" class="text " value="<?php echo $rHmodal['no_pesanan']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="tempohjaminan" maxlength="30" class="text " value="<?php echo $rHmodal['tempoh_jaminan']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
