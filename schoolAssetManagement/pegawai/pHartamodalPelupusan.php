		...
		<div id="content">
			<div class="inner">
				...
				if(!empty($_GET['del_id'])){
					if( empty($_GET['token']) || $_GET['token'] != $_SESSION['tokenHartamodalPelupusanDel'] ){
						echo"
						<div class='section'>
						...
						unset($_SESSION['tokenHartamodalPelupusanDel']);
					}
				}

				$token = md5(uniqid(rand(), true));
				$_SESSION['tokenHartamodalPelupusanDel'] = $token;
				...
				<?php
					...
					if(isset($_POST['daftar'])){
						...
						if($notvalid == true){
							...
							$createUser= "INSERT INTO pelupusan (rujukan, tarikh,kaedah,harta_modal_id, pengguna_id, tarikh_daftar) VALUES 
								('$rujukan','$tarikhFormat','$kaedah','$IdHartamodal','$userID',now())";
				...
				<div class="section">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								...
								<ul class="section_menu left">
									...
									<li><a href="pHartamodalPelupusan.php?id=<?php echo $id; ?>" class="selected_lk"><span class="l"><span></span></span><span class="m"><em>PELUPUSAN/HAPUS KIRA</em><span></span></span><span class="r"><span></span></span></a></li>
								</ul>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<?php
						$sql= "select * from  Hartamodal	where id = '$id' ";
						$rHmodal = $db->sql_list($sql);
												...
												<tr class="'.$colorRow.'">
													...
													<td>
														<div class="actions_menu" >
															<ul>
																<li><a class="edit" href="pHartamodalPelupusanKemaskini.php?id='.$id.'&subid='.$i['0'].'">Kemaskini</a></li>
																<li><a class="delete" href="pHartamodalPelupusan.php?id='.$id.'&del_id='.$i['0'].'&token='.$_SESSION['tokenHartamodalPelupusanDel'].'">Hapus</a></li>
															</ul>
														</div>
													</td>
												</tr>';
