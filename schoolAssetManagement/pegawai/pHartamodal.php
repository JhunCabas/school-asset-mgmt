		...
		<div id="content">
			<div class="inner">
				...
				if(!empty($_GET['del_id'])){
					if( empty($_GET['token']) || $_GET['token'] != $_SESSION['tokenHartaModalDel'] ){
						echo"
						<div class='section'>
						...
						// All fine: delete 
						$qDel= "delete from hartamodal where id = $_GET[del_id]" ;
						$rDel = $db->sql_query($qDel);
						if($rDel){
							echo"
							<div class='section'>
								<ul class='system_messages'>
									<li class='green'><span class='ico'></span><strong class='system_title'>Data harta modal berjaya dihapuskan!</strong> </li>
								</ul>
							</div>";
						}							
						// Unset the token, so that it cannot be used again.
						unset($_SESSION['tokenHartaModalDel']);
					}
				}

				$token = md5(uniqid(rand(), true));
				$_SESSION['tokenHartaModalDel'] = $token;
					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2>Senarai Harta Modal (KEW.PA-2):</h2>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<div class="section_content_inner">
							<?php
								...
								$param = "&nosiri=$nosiri";
							?>
							<form action="pHartamodal.php" method="POST" class="search_form">
							...
							<a href="pHartamodalDaftar.php" class="update"><span><span><em>Daftar Harta Modal</em><strong></strong></span></span></a>
							</div>
							...
							<div class="table_wrapper">
								...
								<?php  
									...
									*/
									$qCount= "select COUNT(*) from hartamodal where no_siri_daftar like '%$nosiri%'  
									...
									/* Get data. */
									$qList= "select * from  hartamodal where no_siri_daftar like '%$nosiri%'  
												 order by tarikh_daftar desc 
												 LIMIT $start, $limit ";
											...
											<tr class="'.$colorRow.'">
												...
												<td>
													<div class="actions_menu" >
														<ul>
															<li><a class="details" href="pHartamodalPapar.php?id='.$i['id'].'">Papar</a></li>
															<li><a class="edit" href="pHartamodalKemaskini.php?id='.$i['id'].'">Kemaskini</a></li>
															<li><a class="delete" href="pHartamodal.php?del_id='.$i['id'].'&token='.$_SESSION['tokenHartaModalDel'].'">Hapus</a></li>
														</ul>
													</div>
												</td>
											</tr>';
