				...
				<?php
					...
					if(isset($_POST['kemaskini'])){
						...
						if($notvalid == true){
							...
							$updateinventori= "UPDATE  inventori set kaedah_peroleh='$kaedahperolehan', no_siri_daftar='$nosiripendaftaran', kementerian='$kementerian',
								bahagian='$bahagian',kod_nasional='$kodnasional',kategori_id='$kategoriID',sub_kategori_id='$kategoriSubID',jenis_id='$jenisID',
								kuantiti='$kuantiti',unit_ukur='$unitukur',
								harga_perolehan_asal='$hargaasal',tarikh_terima='$tarikhterimaFormat',
								no_pesanan='$nopesananrasmi',	tempoh_jaminan='$tempohjaminan',				
								pembekal_id='$pembekal' where id='$Idinventori' ";
							$result = $db->sql_query($updateinventori);
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								...
								<ul class="section_menu left">
									<li><a href="pInventoriKemaskini.php?id=<?php echo $id; ?>" class="selected_lk"><span class="l"><span></span></span><span class="m"><em>INVENTORI (KEW.PA-3)</em><span></span></span><span class="r"><span></span></span></a></li>
						...
						<form action="" method="POST" class="search_form general_form">
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper" style="border:none; width:300px;"><input name="kementerian"  maxlength="50" readonly class="text" value="<?php echo $rInv['kementerian']; ?>" type="text" /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper" style="border:none; width:300px;"><input name="bahagian"  maxlength="50" readonly class="text" value="<?php echo $rInv['bahagian']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="kodnasional" maxlength="16" class="text " value="<?php echo $rInv['kod_nasional']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="kuantiti" maxlength="6" class="text " value="<?php echo $rInv['kuantiti']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="unitukur" maxlength="30" class="text " value="<?php echo $rInv['unit_ukur']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="hargaasal" maxlength="6" class="text numbersOnly" value="<?php echo $rInv['harga_perolehan_asal']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="tarikhterima" id="datepicker" class="text" value="<?php echo changeDateBeginDay($rInv['tarikh_terima']); ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="nopesananrasmi" maxlength="30" class="text " value="<?php echo $rInv['no_pesanan']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
								...
								<div class="row">
									...
									<div class="inputs">
										<span class="input_wrapper"><input name="tempohjaminan" maxlength="30" class="text " value="<?php echo $rInv['tempoh_jaminan']; ?>" type="text"  /></span>
									</div>
								</div>
								<!--[if !IE]>end row<![endif]-->
